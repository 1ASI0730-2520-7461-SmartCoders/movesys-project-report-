...
| 26 | TS-01 | API Endpoints for User                | Como desarrollador, quiero disponer de endpoints CRUD para gestionar los datos de usuarios (conductores, administradores, etc.) para el contexto IAM. | 8 |
| 27 | TS-03 | API Endpoints for Delivery            | Como desarrollador, quiero utilizar endpoints para registrar, actualizar y consultar el estado de las entregas y sus detalles. | 8 |
| 28 | TS-02 | API Endpoints for Fuel Consumption    | Como desarrollador, quiero tener endpoints para registrar y consultar los datos de consumo de combustible por vehículo y por ruta. | 5 |
| 29 | TS-04 | API Endpoints for Maintenance         | Como desarrollador, quiero disponer de endpoints CRUD para programar, registrar y consultar el historial de mantenimiento de la flota. | 5 |
| 30 | TS-05 | API Endpoints for Report              | Como desarrollador, quiero un conjunto de endpoints estandarizados para generar diferentes tipos de reportes consolidados (ej. rendimiento, fallas, costos) en varios formatos. | 5 |
| 31 | TS-06 | API Endpoints for Fleet               | Como desarrollador, quiero tener endpoints para gestionar la información de la flota completa (vehículos, licencias, seguros) de manera centralizada. | 5 |
